...
之前本科的毕设是做的数据挖掘的关联分析，前两天看到有人用机器学习来做分析生活习惯的，觉得也挺有意思的，拿起课本玩了一下，结果令人感叹。

以下是截图：

![影响因素](/img/post/2016-09-23/weight_factor.png)

数据不太多，还不够准确，利用VW框架回归确实方便。还需要多记录下日常。
